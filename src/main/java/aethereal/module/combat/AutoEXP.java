...
public class AutoEXP extends Module {
    ...
    public void a(TickEvent event) {
        ...
        if (!this.c && this.d[0] != -1) {
            ...
            if (this.d[1] != -1) {
                Delta.getInstance().getModuleProcessor().v().a().a(7, this.d[1], 1);
            }
            this.d[0] = -1;
            this.d[1] = -1;
        }
    ...
    private void q() {
        ...
        if (!inHand) {
            ...
            if (hotbarSlot != -1) {
                ...
                if (Delta.getInstance().getModuleProcessor().v().a().a().isEmpty() && this.c && (invSlot = InventoryUtil.b(Items.EXPERIENCE_BOTTLE)) != -1) {
                    if (this.d[1] == -1) {
                        this.d[1] = invSlot;
                    }
                    ...
                    Delta.getInstance().getModuleProcessor().v().a().a(invSlot, 7, 1);
                    return;
                }
                return;
            }
        ...
        Delta.getInstance().getModuleProcessor().k().a(new Rotation(Look.b() + smoothYaw, 86.0f + smoothPitch), 70.0f, 1, 3);
