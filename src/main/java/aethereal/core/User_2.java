...
public record User_2(String id, String username, String discriminator, String globalName, String avatar, boolean bot) {
    ...
    public static User_2 fromJson(JsonObject json) {
